/* Basit Iterasyon (Jacobi) Yontemi Matris icin */
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
void maxDiagonal(float[30][30],int);
void jacobiItr(float[30][30],float[30],float,int);
int main()
{
    float mat[30][30],x[30],eps;
    int n;
    printf("Basit Iterasyon (Jacobi) Yontemi Matris icin.\n\nMatrisin boyutu (Bilinmeyenler sayisi) giriniz : ");
    scanf("%d",&n);
...
void jacobiItr(float mat[30][30], float x[30], float eps, int n)
{
	int itr=0,i,j;
